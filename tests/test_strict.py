...
from crazy_workers.manager import WorkerManager
from crazy_workers.models import WorkerStatus
...
class TestStrictResilience(BaseTestCase):
  ...
  def test_log_file_capture(self):
    ...
    worker_key = 'log_test'
    self.manager.start_worker('batch_worker', worker_key=worker_key, parameters={'items': ['test_item_123'], 'delay': 0.1})
  ...
  def test_concurrent_recovery_lock(self):
    ...
    from crazy_workers.recovery import RecoveryLock
